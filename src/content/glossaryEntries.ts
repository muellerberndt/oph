...
export const GLOSSARY_ENTRIES: GlossaryEntry[] = [
    ...
    },
    {
        ...
        definition: 'Tensor completion of null closure, with Lambda fixed by the global N_CRC record-capacity fixed point.',
        category: 'gravity',
    ...
    },
    {
        ...
        definition: 'Global readback fixed-point equation tying Lambda to finite screen Hilbert-space capacity.',
        category: 'gravity',
    ...
    },
    {
        ...
        definition: 'Unique local fixed-point closure value controlling UV cell scale, entropy target, and gauge-closure solution.',
        category: 'spectrum',
        usedIn: ['Matter Continuations', 'Synthesis'],
    },
    {
        term: 'Cosmic Record Capacity',
        symbol: 'N_CRC = F(N_CRC)',
